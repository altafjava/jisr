...
//
//	@PostMapping("/signup")
//	public ResponseEntity<?> registerUser(@Valid @RequestBody PatientAuthDTO patientDTO) {
//		patientService.registerUser(patientDTO);
//		return ResponseEntity.ok("Patient registered successfully.");
//	}
//
//	@PostMapping("/login")
//	public ResponseEntity<?> authenticateUser(@RequestBody LoginDTO loginRequestDTO) {
...
//		String jwt = jwtUtil.generateToken(userDetails.getUser().getId(), emailOrPhone);
